...
// All hotspots start at 'low' and rise to 'elevated' or 'high' based on matching news items
// Escalation scores: 1=stable, 2=watchlist, 3=elevated, 4=high tension, 5=critical/active conflict
// CUSTOMIZED: Indonesia-focused hotspots
export const INTEL_HOTSPOTS: Hotspot[] = [
  {
    id: 'jakarta',
    name: 'Jakarta',
    subtext: 'Political Center',
    lat: -6.2088,
    lon: 106.8456,
    location: 'Jakarta, Indonesia',
    keywords: ['jakarta', 'jokowi', 'prabowo', 'dpr', 'mpr', ' istana', 'demo', 'banjir'],
    agencies: ['Polri', 'TNI', 'BIN'],
    description: 'Political and economic capital. Center of government and business activities.',
    status: 'Monitoring',
    escalationScore: 1,
    escalationTrend: 'stable',
    escalationIndicators: ['Mass protests', 'Political instability', 'Flooding events'],
    history: {
      lastMajorEvent: '2019 Election Protests',
      lastMajorEventDate: '2019-05-21',
      precedentCount: 3,
      precedentDescription: '1998 Riots, 2016 212 Movement, 2019 Election Riots',
      cyclicalRisk: 'Flood season (Jan-Feb), Election cycles',
    },
    whyItMatters: 'Primary decision-making center; 70% of money circulation in Indonesia.',
  },
  {
    id: 'ikn',
    name: 'Nusantara (IKN)',
    subtext: 'New Capital Project',
    lat: -0.973,
    lon: 116.708,
    location: 'East Kalimantan, Indonesia',
    keywords: ['ikn', 'nusantara', 'new capital', 'penajam paser utara', 'kalimantan timur', 'jokowi'],
    agencies: ['OIKN', 'PUPR'],
    description: 'Strategic national project. Massive infrastructure development zone.',
    status: 'Monitoring',
    escalationScore: 1,
    escalationTrend: 'stable',
    escalationIndicators: ['Construction delays', 'Investment withdrawal', 'Land disputes'],
    history: {
      lastMajorEvent: 'Groundbreaking Ceremony',
      lastMajorEventDate: '2022-03-14',
      precedentCount: 0,
      precedentDescription: 'First major capital relocation in Indonesian history',
      cyclicalRisk: 'Investment cycles',
    },
    whyItMatters: 'Symbol of future governance; high investment value; environmental concerns.',
  },
  {
    id: 'papua',
    name: 'Papua Highlands',
    subtext: 'Separatist Conflict',
    lat: -4.269,
    lon: 138.080,
    location: 'Papua Pegunungan, Indonesia',
    keywords: ['papua', 'opm', 'kkb', 'wamena', 'nduga', 'intrepid', 'puncak jaya', 'jayapura', 'west papua'],
    agencies: ['TNI', 'Polri', 'Satgas Damai Cartenz'],
    description: 'Active low-level insurgency. KKB/OPM activities.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'escalating',
    escalationIndicators: ['Hostage taking', 'Attacks on civilians/infrastructure', 'Military casualties'],
    history: {
      lastMajorEvent: 'Pilot hostage crisis',
      lastMajorEventDate: '2023-02-07',
      precedentCount: 10,
      precedentDescription: 'Decades of separatist low-intensity conflict',
      cyclicalRisk: 'December 1st (OPM anniversary)',
    },
    whyItMatters: 'Sovereignty issue; heavy military presence; human rights scrutiny.',
  },
  {
    id: 'natuna',
    name: 'North Natuna Sea',
    subtext: 'Maritime Security',
    lat: 3.945,
    lon: 108.143,
    location: 'Riau Islands, Indonesia',
    keywords: ['natuna', 'south china sea', 'eez', 'coast guard', 'china coast guard', 'fishing', 'bakamla', 'tni al'],
    agencies: ['Bakamla', 'TNI AL'],
    description: 'EEZ border with South China Sea claims. Illegal fishing and sovereignty patrols.',
    status: 'Monitoring',
    escalationScore: 2,
    escalationTrend: 'stable',
    escalationIndicators: ['Coast guard standoff', 'IUU fishing surge', 'Military exercises'],
    history: {
      lastMajorEvent: 'ZEE standoff with China',
      lastMajorEventDate: '2020-01-01',
      precedentCount: 5,
      precedentDescription: 'Recurring incursions by foreign vessels',
      cyclicalRisk: 'Calm sea seasons favoring fishing (Apr-Sept)',
    },
    whyItMatters: 'Resource rich (gas/fish); Integrity of EEZ; Geopolitical friction point.',
  },
  {
    id: 'morowali',
    name: 'Morowali',
    subtext: 'Industrial Park',
    lat: -2.626,
    lon: 121.944,
    location: 'Central Sulawesi',
    keywords: ['morowali', 'imip', 'nickel', 'smelter', 'chinese workers', 'labor unrest', 'sulteng'],
    agencies: ['Polri'],
    description: 'Key nickel processing hub. Foreign investment concentration.',
    status: 'Monitoring',
    escalationScore: 2,
    escalationTrend: 'stable',
    escalationIndicators: ['Labor strikes', 'Industrial accidents', 'Ethnic tensions'],
    history: {
      lastMajorEvent: 'Smelter explosion',
      lastMajorEventDate: '2023-12-24',
      precedentCount: 3,
      precedentDescription: 'Several industrial accidents and labor protests',
      cyclicalRisk: 'None',
    },
    whyItMatters: 'Critical for EV battery supply chain; major foreign direct investment.',
  },
  {
    id: 'bali',
    name: 'Bali',
    ...
    keywords: ['bali', 'denpasar', 'tourist', 'bule', 'g20', 'ngurah rai'],
    agencies: ['Polri', 'Immigration'],
    description: 'Primary tourism destination. International events venue.',
    status: 'Monitoring',
    escalationScore: 1,
    escalationTrend: 'stable',
    escalationIndicators: ['Terror threat', 'Visa violations', 'Natural disaster (Agung)'],
    history: {
      lastMajorEvent: 'Failed bombing plot',
      lastMajorEventDate: '2019',
      precedentCount: 2,
      precedentDescription: '2002 and 2005 Bombings',
      cyclicalRisk: 'Holiday seasons',
    },
    whyItMatters: 'Face of Indonesian tourism; Economic driver; Reputation sensitive.',
  },
];
